...
!Global("ForgedItem","RR3101",10)
!Global("Ifixthisabit","RR3101",2)
...
!Global("SmithApprextra","RR3101",5)~ THEN BEGIN 1
  SAY @1 
  IF ~~ THEN GOTO 2
END
...
!Global("SmithApprextra","RR3101",3)
!Global("SmithApprextra","RR3101",4)
!Global("SmithApprextra","RR3101",5)~ THEN BEGIN 20
  SAY @42 
...
PartyHasItem("SW1H49")~ THEN REPLY @31 GOTO 109
  IF ~PartyHasItem("NewShP1")
PartyHasItem("NewShP2")
PartyHasItem("NewShP3")~ THEN REPLY @51 GOTO 111
  IF ~PartyHasItem("AX1H08")
PartyHasItem("NewRuMo")
...
IF ~~ THEN BEGIN 33 // from: 14.1
  SAY @60
  IF ~PartyGoldGT(2999)~ THEN REPLY @61 DO ~TakePartyGold(3000)
...
Global("Brundtalk","RR3101",0)~ THEN BEGIN 36
  SAY @66
  IF ~~ THEN REPLY @67 DO ~SetGlobal("ForgedItem","RR3101",0)
...
IF ~Global("Ifixthisabit","RR3101",2)
Global("ForgedItemGray","RR3101",1)~ THEN BEGIN 42
  SAY @73
...
IF ~Global("Ifixthisabit","RR3101",2)
Global("ForgedItemGray","RR3101",6)~ THEN BEGIN 55
  SAY @81
...
IF ~Global("Ifixthisabit","RR3101",2)
Global("ForgedItemGray","RR3101",12)~ THEN BEGIN 63
  SAY @83
...
IF ~~ THEN BEGIN 93 // from: 14.6
  SAY @107
  IF ~PartyGoldGT(2499)~ THEN REPLY @61 DO ~TakePartyGold(2500)
TakePartyItem("NewBeH1")
TakePartyItem("NewBeH2")
TakePartyItem("NewBeH3")
DestroyItem("NewBeH1")
DestroyItem("NewBeH2")
DestroyItem("NewBeH3")~ GOTO 94
  IF ~~ THEN REPLY @62 GOTO 14
  IF ~~ THEN REPLY @63 GOTO 35
END
...
IF ~~ THEN BEGIN 134 // from:
  SAY @122 
  IF ~~ THEN EXTERN ~GRAYFOOT~ 177
END

IF ~~ THEN BEGIN 135 // from:
  SAY @123 
  IF ~~ THEN EXTERN ~GRAYFOOT~ 178
END
...
IF ~Global("SmithApprsc","GLOBAL",3)~ THEN BEGIN 137
  SAY @125 
  IF ~~ THEN DO ~SetGlobal("SmithApprsc","GLOBAL",4)~ EXIT
END

IF ~Global("SmithApprsc","GLOBAL",4)~ THEN BEGIN 138
  SAY @126 
  IF ~~ THEN DO ~SetGlobal("SmithApprsc","GLOBAL",5)~ EXIT
END

IF ~Global("SmithApprsc","GLOBAL",6)
Global("SmithApprextra","RR3101",1)~ THEN BEGIN 139
  SAY @127 
  IF ~~ THEN DO ~SetGlobal("SmithApprsc","GLOBAL",7)~ EXIT
END

IF ~~ THEN BEGIN 140 // from:
  SAY @128 
  IF ~~ THEN EXTERN ~GRAYFOOT~ 180
END

IF ~~ THEN BEGIN 141 // from:
  SAY @129 
  IF ~~ THEN DO ~SetGlobal("SmithApprsc","GLOBAL",8)~ EXIT
END

IF ~~ THEN BEGIN 142 // from:
  SAY @130 
  IF ~~ THEN DO ~SetGlobal("SmithApprsc","GLOBAL",9)
SetGlobal("SmithApprextra","RR3101",0)~ EXIT
END

IF ~Global("SmithApprsc","GLOBAL",10)
Global("SmithApprextra","RR3101",2)~ THEN BEGIN 143
  SAY @131 
  IF ~~ THEN EXTERN ~GRAYFOOT~ 182
END

IF ~~ THEN BEGIN 144 // from:
  SAY @132 
  IF ~~ THEN EXTERN ~GRAYFOOT~ 183
END

IF ~~ THEN BEGIN 145 // from:
  SAY @133 
  IF ~~ THEN EXTERN ~GRAYFOOT~ 184
END

IF ~~ THEN BEGIN 146 // from:
  SAY @134 
  IF ~~ THEN DO ~SetGlobal("SmithApprsc","GLOBAL",11)
SetGlobal("SmithApprextra","RR3101",0)~ EXIT
END

IF ~Global("SmithApprsc","GLOBAL",13)
Global("SmithApprextra","RR3101",3)~ THEN BEGIN 147
  SAY @135 
  IF ~~ THEN EXTERN ~GRAYFOOT~ 185
END

IF ~~ THEN BEGIN 148 // from:
  SAY @136 
  IF ~~ THEN EXTERN ~GRAYFOOT~ 186
END

IF ~~ THEN BEGIN 149 // from:
  SAY @137 
  IF ~~ THEN EXTERN ~GRAYFOOT~ 187
END

IF ~Global("SmithApprsc","GLOBAL",15)
Global("SmithApprextra","RR3101",4)~ THEN BEGIN 150
  SAY @138 
  IF ~~ THEN EXTERN ~GRAYFOOT~ 188
END

IF ~~ THEN BEGIN 151 // from:
  SAY @139 
  IF ~~ THEN DO ~SetGlobal("SmithApprsc","GLOBAL",16)
SetGlobal("SmithApprextra","RR3101",0)~ EXIT
END

IF ~Global("SmithApprsc","GLOBAL",17)
Global("SmithApprextra","RR3101",5)~ THEN BEGIN 152
  SAY @140 
  IF ~~ THEN EXTERN ~GRAYFOOT~ 189
END

IF ~~ THEN BEGIN 153 // from:
  SAY @141 
  IF ~~ THEN EXTERN ~GRAYFOOT~ 190
END

IF ~~ THEN BEGIN 154 // from:
  SAY @142 
  IF ~~ THEN EXTERN ~GRAYFOOT~ 191
END

IF ~~ THEN BEGIN 155 // from: 132.0
  SAY @121 
  IF ~~ THEN EXTERN ~GRAYFOOT~ 176
END
